document.addEventListener("DOMContentLoaded", () => {
  ...
  form.addEventListener("submit", async function (e) {
    ...
    try {
      ...
      doc.text("WYCON Cosmetics", 20, y); y += lineHeight;
      doc.text("Website: www.wyconcosmetics.com", 20, y); y += lineHeight;
      doc.text("Instagram: @wycon_cosmetics", 20, y); y += lineHeight * 2;
  ...
  function afterDownloadSuccess(data) {
    try {
      ...
      if (emailLink) {
        ...
        emailLink.href = `mailto:wyconcosmeticscollaboration@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
      }
    } catch (err) {
